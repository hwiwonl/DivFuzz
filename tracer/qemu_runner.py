...
from tracer.tinycore import TinyCore
...
class QEMURunner(object):
    ...
    @contextlib.contextmanager
    def _exec_func(self, qemu_variant, qemu_args, program_args, ld_path=None,
                   stdin=None, stdout=None, stderr=None, record_trace=True,
                   core_target=None):  # pylint:disable=method-hidden
